...
;	Main.c:111: PassWord_Set1_1 = PassWord_Set / 1000;
...
;	Main.c:112: PassWord_Set1 = PassWord_Set1 *10 + PassWord_Set1_1;
...
;	Main.c:113: PassWord_Set2 = PassWord_Set % 1000;
...
;	Main.c:114: PassWord_Set = PassWord_Set2;
...
;	Main.c:117: LCD_ShowNum(2,4,PassWord_Set1,3);
	...
	mov	dpl,#0x02
	lcall	_LCD_ShowNum
;	Main.c:118: LCD_ShowNum(2,7,PassWord_Set2,3);
...
;	Main.c:127: AT24C02_WriteByte(1,PassWord_Set1 / 256);// 高字节
	mov	r6,(_PassWord_Set1 + 1)
	mov	_AT24C02_WriteByte_PARM_2,r6
	mov	dpl,#0x01
	lcall	_AT24C02_WriteByte
;	Main.c:129: AT24C02_WriteByte(2,PassWord_Set2 % 256);// 低字节
	mov	r6,_PassWord_Set2
	mov	_AT24C02_WriteByte_PARM_2,r6
	mov	dpl,#0x02
	lcall	_AT24C02_WriteByte
;	Main.c:130: AT24C02_WriteByte(3,PassWord_Set2 / 256);
